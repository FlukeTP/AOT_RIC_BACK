...
@Entity
@Table(name = "ric_it_network_charge_rates_config")
public class RicItNetworkChargeRatesConfig implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1417279791133377425L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "it_network_config_id")
