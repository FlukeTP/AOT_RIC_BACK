...
@Entity
@Table(name = "ric_firebrigade_rate_charge_config")
public class RicFirebrigadeRateChargeConfig implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4390692085539000958L;
