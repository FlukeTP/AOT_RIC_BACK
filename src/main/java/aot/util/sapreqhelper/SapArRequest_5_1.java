...
@Service
public class SapArRequest_5_1 implements SapArRequest {
	@Autowired
	...
	public ArRequest getARRequest(String busPlace, String comCode, String id, String doctype) {
		...
		ArRequest returnRequest = commonARRequest.getThreeTemplate(busPlace, comCode, doctype,
				electricReq.getTransactionNoCash());
		...
		item1.setText(electricReq.getRemark());
		...
		item2.setText(electricReq.getRemark());
		...
		item3.setTaxCode("O7");
		item3.setTaxBaseAmount(totalChargeRate.toString());
		...
		item3.setText(electricReq.getRemark());
