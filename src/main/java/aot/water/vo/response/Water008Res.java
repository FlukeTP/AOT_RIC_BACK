...
public class Water008Res {
	...
	private String oldRentalAreaCode;
	...
	private String newRentalAreaCode;
	...
	private String showButtonCash;
	private String showButtonLg;
	private Long reqId;

	public String getWaterChangeId() {
		return waterChangeId;
	}

	public void setWaterChangeId(String waterChangeId) {
	...
	public String getOldMeterName() {
		return oldMeterName;
	}

	public void setOldMeterName(String oldMeterName) {
		this.oldMeterName = oldMeterName;
	}
	...
	public String getOldMeterLocation() {
		return oldMeterLocation;
	}

	public void setOldMeterLocation(String oldMeterLocation) {
		this.oldMeterLocation = oldMeterLocation;
	}

	public String getOldRentalAreaCode() {
		return oldRentalAreaCode;
	}

	public void setOldRentalAreaCode(String oldRentalAreaCode) {
		this.oldRentalAreaCode = oldRentalAreaCode;
	}
	...
	public String getNewMeterLocation() {
		return newMeterLocation;
	}

	public void setNewMeterLocation(String newMeterLocation) {
		this.newMeterLocation = newMeterLocation;
	}

	public String getNewRentalAreaCode() {
		return newRentalAreaCode;
	}

	public void setNewRentalAreaCode(String newRentalAreaCode) {
		this.newRentalAreaCode = newRentalAreaCode;
	}
	...
	public String getShowButtonCash() {
		return showButtonCash;
	}

	public void setShowButtonCash(String showButtonCash) {
		this.showButtonCash = showButtonCash;
	}

	public String getShowButtonLg() {
		return showButtonLg;
	}

	public void setShowButtonLg(String showButtonLg) {
		this.showButtonLg = showButtonLg;
	}
