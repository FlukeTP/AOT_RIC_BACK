...
@Entity
public class RicWaterMaintenanceChargeRatesConfig implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1922980244361375044L;
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "water_maintenance_config_id")
