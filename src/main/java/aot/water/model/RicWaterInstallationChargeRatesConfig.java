...
@Entity
public class RicWaterInstallationChargeRatesConfig implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7787094462005616785L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "water_installation_id")
