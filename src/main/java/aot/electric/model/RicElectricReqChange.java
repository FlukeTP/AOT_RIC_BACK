...
@Entity
@Table(name = "ric_electric_req_change")
public class RicElectricReqChange implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 720412642903509817L;
