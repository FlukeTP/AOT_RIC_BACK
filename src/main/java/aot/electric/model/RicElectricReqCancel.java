...
@Entity
@Table(name = "ric_electric_req_cancel")
public class RicElectricReqCancel implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7176177542739496118L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "req_cancel_id")
	private Long reqCancelId;
	...
	public Long getReqCancelId() {
		return reqCancelId;
	}

	public void setReqCancelId(Long reqCancelId) {
